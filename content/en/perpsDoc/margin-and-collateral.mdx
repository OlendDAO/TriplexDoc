...
Threshold's wrapped Bitcoin is tradable on EVM chains. While tBTC serves a similar purpose to other wrapped assets and stablecoins on Ethereum, Threshold decentralizes the management and custody of the underlying BTC. Oracles track the value of tBTC deposits when opening trades and calculating maintenance margin.
