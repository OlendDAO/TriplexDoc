...
The multi-collateral feature allows traders to deposit assets such as ETH and tBTC. Traders can leverage the USD value of these asset types without losing exposure to them.
...
Threshold's wrapped Bitcoin is tradable on EVM chains. While tBTC serves a similar purpose to other wrapped assets and stablecoins on Ethereum, Threshold decentralizes the management and custody of the underlying BTC. Oracles track the value of your tBTC deposits when opening trades and calculating maintenance margin.

To learn more about tBTC, visit [Threshold Network Blog](https://blog.threshold.network/bridging-the-gap-the-basics-of-tbtc/).
...
**A**: The main differences lie in price volatility and associated risks. Stablecoins offer constant value, while crypto assets like ETH or tBTC may fluctuate, affecting your account health.
